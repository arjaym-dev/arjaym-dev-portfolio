...
const Dots = () => {
    return (
        <div
            className={`w-2 h-2 bg-custom-dark dark:bg-custom-light rounded-full group-hover:bg-custom-fuchsia transition-all`}
        ></div>
    )
}
    ...
    return (
        <div className="group">
            <motion.div
                ...
                onClick={handleMenu}
                className="bg-white dark:bg-custom-dark absolute right-4 border-2 z-100 rounded-tl-lg rounded-bl-lg hover:border-custom-fuchsia hover:bg-custom-fuchsia/20 transition-all overflow-hidden"
            >
